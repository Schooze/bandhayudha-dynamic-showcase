              ...
              {divisions.map((division, index) => (
                <Card key={index} className="shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-600 text-sm mb-3">{division.description}</p>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Contact us at <a href="mailto:bandhayudha.undip@gmail.com" className="text-blue-600 hover:underline">
